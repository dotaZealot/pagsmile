---
description: How to use AlipayPlus to submit a payin in Philippines.
---

# AlipayPlus

{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by AlipayPlus " %}
{% swagger-description %}
This endpoint allows you to submit a payin by AlipayPlus in Philippines.
