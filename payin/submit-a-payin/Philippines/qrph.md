---
description: How to use QRPH to submit a payin in Philippines.
---

# QRPH

{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by QRPH" %}
{% swagger-description %}
This endpoint allows you to submit a payin by QRPH in Philippines.
...
```
{
    ...
    "prepay_id":"MkZBZ***c171F5F",
    "qr_code":"00020101021***M1XXX63049110"
}
```
{% endswagger-response %}
