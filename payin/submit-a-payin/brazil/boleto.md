...
{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by Boleto" %}
{% swagger-description %}
...
{% swagger-parameter in="body" name="timeout_express" type="strng" %}
...
![Example of payment page](<../../../.gitbook/assets/image (17).png>)

![Example of Boleto PDF](<../../../.gitbook/assets/image (23).png>)
