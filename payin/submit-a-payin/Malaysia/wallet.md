---
description: How to use Wallet to submit a payin in Malaysia.
---
...
{% swagger-description %}
This endpoint allows you to submit a payin by Wallet in Malaysia.
...
<strong>    "wallet_url": "https://msp.boost-my.com/onlinepayment/authorise?source=alipay-connect&#x26;codeValue="
</strong>}
</code></pre>
{% endtab %}
...
```
{
    ...
    "web_url": "",
    "trade_status": "PROCESSING",
    "wallet_url":"https://m.dana.id/m/ac/init?ACCodeValue="
}
```
{% endtab %}
{% endtabs %}
