---
description: How to use CreditCard to submit a payin in United Arab Emirates.
---
...
{% swagger-description %}
This endpoint allows you to submit a payin by CreditCard in United Arab Emirates.
