---
description: How to use OTC to submit a payin in Taiwan.
---

# OTC

{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by OTC" %}
{% swagger-description %}
This endpoint allows you to submit a payin by OTC in **Taiwan**.
...
| 苹南寞 ATM     | PD-ATM-HNCB    |
| 上海寞 ATM     | PD-ATM-SCSB    |
| 中国信托WEB-ATM | PD-WEBATM-CTCB |
| 玉山银行WEBATM  | PD-WEBATM-ESUN |
| 苹南WEB-ATM   | PD-WEBATM-HNCB |
