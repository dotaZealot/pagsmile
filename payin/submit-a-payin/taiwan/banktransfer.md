---
description: How to use BankTransfer to submit a payin in Taiwan.
---
...
{% swagger-description %}
This endpoint allows you to submit a payin by BankTransfer in **Taiwan**.
...
```
{
    ...
    "pay_url":"https://checkoutv2.pagsmile.com/public/redirect/post-redirect.html?post_data="
}
```
{% endswagger-response %}
...
| Bank name        | Bank id               |
| ---------------- | --------------------- |
| 全家FAMIPORT       | PD-STORE-FAMI         |
| 莱衡富Life-ET       | PD-STORE-HILIFEET     |
| ibon便利生活站        | PD-STORE-IBON         |
| 超商行勤操碍(7-11、全家)  | PD-STORE-MBC          |
| 超商行勤拂(莱富Life-ET) | PD-STORE-MBC-HILIFEET |
| 0K超商OK-go        | PD-STORE-OKGO         |
