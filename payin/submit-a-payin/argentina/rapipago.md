---
description: How to use Rapipago to submit a payin in Argentina.
---

# ❌ Rapipago

{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by Rapipago " %}
{% swagger-description %}
