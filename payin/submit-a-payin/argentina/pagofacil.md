---
description: How to use PagoFacil to submit a payin in Argentina.
---

# ❌ PagoFacil

{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by PagoFacil" %}
{% swagger-description %}
