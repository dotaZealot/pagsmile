...
```
{
    ...
    "web_url": "",
    "pay_url": "https://secure.payty.com/t/",
...
When the user submitted the payment on the provider's page, the money will be transferred and the payment will be confirmed instantly.
{% endhint %}
