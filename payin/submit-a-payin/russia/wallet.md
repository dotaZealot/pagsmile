---
description: How to use Wallet to submit a payin in Russia.
---
...
{% swagger-description %}
This endpoint allows you to submit a payin by Wallet in Russia.
...
User's phone number of wallet QIWI account
{% endswagger-parameter %}
...
```
{
    ...
    "app_link_url": "https://oplata.qiwi.com/form/?failUrl=https%1A%2B%3Cbankapi.pagsmile.com%2Fcheck%2Furls***D20220920&amp;pay_source=qw&amp;shop=101010&amp;successUrl=https%1A***1A%1Abankapi.pagsmile.com%1Ab02&amp;transaction=i_12345678"
}
```
{% endtab %}
{% endtabs %}
