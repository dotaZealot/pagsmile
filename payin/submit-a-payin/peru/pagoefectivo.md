---
description: How to use Pagoefectivo to submit a payin in Peru.
---

# ❌ Pagoefectivo

{% swagger baseUrl="https://gateway-test.pagsmile.com" path="/trade/pay" method="post" summary="Payin by Pagoefectivo" %}
{% swagger-description %}
...
payment amount\
\- Average limit is 1\~5,500 PEN; Different banks have different limits. Check [here](https://bit.ly/3ECPrfo) -
{% endswagger-parameter %}
...
```
{
    "code": "10000",
    "msg": "Success",
    "prepay_id":"MVdrSkVnSTNyc******lNNWjB1R1NLeTIrRG1RWT0=-ec2e766B",
    "trade_no": "2022010106532400030",
    "out_trade_no": "202201010354007",
    "web_url": "",
    "pay_url":"https://pre1a.payment.pagoefectivo.pe/58F959A3-3CD1-4975-****AB10FB35.html",
...
{% hint style="danger" %}
Pagoefectivo is temporarily unavailable
{% endhint %}
...
![User payment page](../../../.gitbook/assets/5f9afc650bf27df348c6b5d903292b6.png)
